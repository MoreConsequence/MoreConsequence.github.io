...
![TLS 1.2 (2-RTT) vs TLS 1.3 (1-RTT / 0-RTT 早期数据恢复) 握手时序对比](../../../public/images/tls-12-vs-tls-13-handshake-rtt.svg)
...
![TLS 1.2 vs TLS 1.3 握手时序对比：2-RTT 协商 vs 1-RTT (0-RTT) 极速建连](../../../public/images/tls-12-vs-tls-13-handshake-rtt-timeline.svg)
...
![ECDHE 椭圆曲线临时密钥交换数学原理：完美前向安全 (PFS)](../../../public/images/ecdh-ephemeral-key-exchange-math.svg)

...
很多工程师初次搭建语义缓存时，盲目将相似度阈值设为 $0.85$ 或 $0.90$。在生产环境中，这会引发毁灭性的业务灾难：单个否定词或反义动词（如“读”变“写”）在向量空间中的 Cosine 相似度往往依然高达 0.91 以上！
...
![大模型工业级后端全景架构图谱：网关、语义缓存、连续批处理与 PagedAttention](../../../public/images/llm-backend-panoramic-architecture-blueprint.svg)

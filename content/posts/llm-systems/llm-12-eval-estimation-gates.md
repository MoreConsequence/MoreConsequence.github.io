...
评测附带预警：人审门本身会松。arXiv 2609.06213（2026-09-05，11,429 条评审、400 名重复评审人、207 天）测得 AI 代码评审通过率从早期的 30.5% 爬到后期的 36.6%（p=8.6e-8），且语言变化滞后于通过率变化——评审人不是静止的标尺。含义：人工通过率不能当静态 ground truth；门禁基线要定期重标，裁判（模型或人）都要防“越看越松”。

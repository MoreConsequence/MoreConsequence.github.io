...
![HTTP/2 二进制分帧多路复用 vs TCP 单一丢包队头阻塞 (Head-of-Line Blocking)](../../../public/images/http2-frame-multiplexing-tcp-hol-blocking.svg)
...
![TCP 传输层队头阻塞 (Head-of-Line Blocking) 影响全部 HTTP/2 多路复用流](../../../public/images/tcp-hol-blocking-single-packet-loss.svg)

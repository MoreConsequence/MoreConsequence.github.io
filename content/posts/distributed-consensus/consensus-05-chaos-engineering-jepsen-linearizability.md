...
> **致命违规：** 当写操作已经在物理时间上完全返回之后，任何其后发起的读操作如果读到了旧值 `0`，则**直接判定线性一致性被破坏**（发生了 Stale Read 陈旧读）！
...
![Jepsen 经典历史缺陷检验档案：网络分区与脑裂测试矩阵](../../../public/images/consensus-jepsen-defect-archives-matrix.svg)

...
![给模型写的 API：结构化错误形状与 Agent 闭环自愈契约](../../../public/images/llm-tool-calling-error-feedback-self-healing.svg)
...
![大模型 Tool Calling 双向契约流水线：JSON Schema 约束、参数校验与工具执行分发](../../../public/images/json-schema-tool-calling-dispatch-pipeline.svg)
...
![Tool Calling 失败自愈循环：参数异常捕获、错误反哺与自适应修复](../../../public/images/agent-tool-calling-self-healing-retry-loop.svg)

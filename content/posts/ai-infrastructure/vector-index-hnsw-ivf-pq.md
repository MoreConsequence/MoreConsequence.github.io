...
![向量检索三大索引架构：HNSW 图、IVF 倒排桶与 PQ 量化对比](../../../public/images/vector-index-hnsw-ivf-pq-tradeoff.svg)
...
![HNSW 分层小世界图索引结构：跳表启发多层近邻图快速收敛寻径](../../../public/images/hnsw-hierarchical-navigable-small-world-skip-list.svg)
...
![倒排乘积量化 (IVF-PQ) 残差量化与非对称距离计算 (ADC) 架构](../../../public/images/ivf-pq-residual-vector-quantization-compression.svg)

...
![分布式锁的物理本质：GC 停顿导致租约过期、互斥失效与 Fencing Token 击穿防线](../../../public/images/distributed-lock-fencing-token-lease-safety.svg)
...
![分布式锁 Fencing Token 防护模型：Martin Kleppmann 提出的单调递增版本防护](../../../public/images/distributed-lock-fencing-token-kleppmann.svg)
...
![分布式锁选型对比：Redis Redlock (AP 弱一致) vs etcd/Chubby (CP 强一致 Raft 租约)](../../../public/images/redis-redlock-vs-etcd-raft-lease.svg)

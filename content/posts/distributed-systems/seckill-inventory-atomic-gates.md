...
![海量秒杀库存扣减架构：Lua 脚本原子预扣减、分布式三层闸门与防超卖机制](../../../public/images/seckill-inventory-atomic-three-gates-architecture.svg)
...
![秒杀系统四层漏斗拦截拓扑：CDN 静态化 -> 网关限流 -> Redis Lua 原子预扣 -> MQ 异步入库](../../../public/images/seckill-four-tier-defense-gate-pipeline.svg)
...
![Redis Lua 原子脚本扣库存：原子性校验、防超卖与回退补偿闭环](../../../public/images/redis-lua-atomic-inventory-deduction.svg)

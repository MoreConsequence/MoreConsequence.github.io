...
![分库分表工程实战：分片键选择、跨分片聚合查询与平滑双写数据迁移](../../../public/images/database-sharding-partition-key-cross-shard-migration.svg)
...
![分库分表分片键策略对比：Hash 取模 (均匀离散) vs Range 范围分片 (时间局部性)](../../../public/images/database-sharding-hash-vs-range-topology.svg)
...
![分库分表平滑迁移四部曲：全量数据同步 -> 增量双写 -> 数据校验 Diff 对齐 -> 毫秒级无感切流](../../../public/images/sharding-dual-write-diff-cutover-migration.svg)
